...
export declare function connectRootElement(elm: HTMLElement): void;
export declare function disconnectedRootElement(elm: HTMLElement): void;
export declare function appendVM(vm: VM): void;
export declare function removeVM(vm: VM): void;
export declare function createVM(elm: HTMLElement, def: ComponentDef, options: {
    mode: 'open' | 'closed';
    owner: VM | null;
    isRoot: boolean;
}): VM;
